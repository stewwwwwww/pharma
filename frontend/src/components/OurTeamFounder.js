...
const OurTeamFounder = () => {
  ...
  return (
    <div
      className="shadowContainer relative mx-4 my-16 mb-[3.75rem] flex flex-col gap-10 rounded-[0.625rem] border-2 pb-5 
      pt-10 md:my-20 lg:my-24 lg:flex-row lg:gap-20 lg:px-0 lg:pl-12 
    lg:pr-5 lg:pt-6 xl:mx-auto xl:my-36 xl:max-w-[75rem]"
    >
      <div
