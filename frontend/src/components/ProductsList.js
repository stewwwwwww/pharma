              ...
              return (
                <div
                  className="group relative flex h-[26rem] flex-col items-center
                   ...
                   bg-center bg-no-repeat px-5 py-8 lg:h-[28rem]"
                  style={{
                  ...
                  <div className="z-10 flex flex-col items-center">
                    <h4
                      className={classNames("relative text-white", {
                        "duration-500 translate-y-24 transition-transform ease-in-out group-hover:translate-y-0":
                          isDesktop,
                      })}
                    >
                      {product.name}
                    ...
                    <p
                      className={classNames(
                        "sm:h-18 mb-10  mt-8 text-white  lg:max-w-[68%]",
                        {
                          "duration-500 forwards opacity-0 transition-opacity ease-in-out group-hover:opacity-100":
                            isDesktop,
                        },
                      )}
                    >
